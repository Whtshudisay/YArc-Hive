...
export default function Sidebar({ view, onViewChange }: Props) {
  return (
    <nav className="absolute left-3 top-1/2 z-30 flex h-[min(820px,90vh)] w-16 -translate-y-1/2 flex-col items-center rounded-full border border-outline/50 bg-card py-5 shadow-card">
