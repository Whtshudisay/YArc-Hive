...
export default function OpenLibraryModal({ open, onClose, onSelect }: Props) {
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/20 p-6">
      <div className="w-full max-w-xl rounded-xl border border-outline/50 bg-card p-6 shadow-card">
        ...
        <div className="mt-4 flex gap-2">
          <input
            className="flex-1 border-b border-outline bg-transparent py-1 font-serif text-lg outline-none"
            value={query}
        ...
        {loading && (
          <p className="mt-4 font-mono text-xs text-muted">Searching…</p>
        )}
